	...
	for (var i=0; i<z.childs.length; i++){
		...
		if (z.childs[i].buff._parser){
			this._h2.forEachChild(row,function(el){
				if (el.childs.length==0)
					b+=parseInt(this._get_cell_value(el.buff,cell),10);
			},this)
			return b;
		}
		b+=parseInt(this._get_cell_value(z.childs[i].buff,cell),10);
	}
	return b;
}
        ...
        if (code.indexOf("[[")!=-1){
          ...
          code=code.replace(test,
              function ($0,$1,$2,$3){
                  ...
                  return "(parseInt(dhtmlx.agrid.cells(\""+$2+"\","+$3+").getValue(),10))";
              }
          );
        }
        ...
        if (code.indexOf(":")!=-1){ 
          ...
          code=code.replace(test,
              function ($0,$1,$2,$3){
                  ...
                  return '(parseInt(dhtmlx.agrid.cells("'+id+'",dhtmlx.agrid.getColIndexById("'+$1+'")).getValue(),10))';
              }
          );
        }
        else{
          ...
          code=code.replace(test,
              function ($0,$1,$2,$3){
                  ...
                  return "(parseInt(dhtmlx.agrid.cells(\""+id+"\","+$1+").getValue(),10))";
              }
          );
        }
